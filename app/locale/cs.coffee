...
#    admin: "Admin"
  ...
  diplomat_suggestion:
    ...
    pitch_body: "Přestože vyvíjíme CodeCombat v angličtině, máme spoustu hráčů z celého světa a mnozí z nich by si rádi zahráli česky, neboť anglicky neumí. Pokud anglicky umíte, přihlaste se prosím jako Diplomat a pomozte nám v překladu webu i jednotlivých úrovní." # {change}
...
#    get_more_codecombat: "Get More CodeCombat"
  ...
  code:
    if: "když" # Keywords--these translations show up on hover, so please translate them all, even if it's kind of long. (In the code editor, they will still be in English.)
    else: "jinak"
    elif: "jinak když"
    while: "dokud"
    loop: "opakuj"
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    email_announcements: "Dostávat novinky o nových úrovních a funkcích CodeCombat" # {change}
...
#    processing: "Processing..."
  ...
  general:
    ...
    withdrawn: "Odvoláno"
    accept: "Přijmout"
    accept_and_save: "Přijmout&Uložit"
    reject: "Odmítnout"
    withdraw: "Odvolat"
